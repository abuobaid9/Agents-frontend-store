      ...
      </form>
      {
        show ? (
          !user ? (
            <>
              <div
                className="modal show" style={{ display: 'block', position: 'absolute',alignItems:"center" }} >
                <Modal.Dialog>
                  ...
                  <Modal.Body>
                    <p  >The  email  or  password  you’ve  entered  is  incorrect.</p>
                  </Modal.Body>

                  <Modal.Footer>
                    <Button variant="warning" onClick={() => setShow(false)} >Ok</Button>
                  </Modal.Footer>
                </Modal.Dialog>
              </div>
            </>
